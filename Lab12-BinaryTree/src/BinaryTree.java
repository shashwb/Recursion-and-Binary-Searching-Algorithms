...
public class BinaryTree<T>
{
    ...
    public int size()
    {
        // this is the default size of the code
        int size = 1;
        if (left != null)
        {
            size = size + left.size();
    ...
    public String toPreOrderString()
    {
        ...
        {
            stringBuilder.append(" ");
            stringBuilder.append(left.toPreOrderString());
        }
        if (right != null)
        {
            stringBuilder.append(" ");
            stringBuilder.append(right.toPreOrderString());
        }
    ...
    public String toInOrderString()
    {
        ...
        if (left != null)
        {
            stringBuilder.append(left.toInOrderString());
            stringBuilder.append(" ");
        }
        ...
        {
            stringBuilder.append(" ");
            stringBuilder.append(right.toInOrderString());
        }
        stringBuilder.append(")");
